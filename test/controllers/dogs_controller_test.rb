...
class DogsControllerTest < ActionController::TestCase
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post :create, dog: { breed: @dog.breed, concerns: @dog.concerns, image: @dog.image, name: @dog.name, suburb: @dog.suburb, weight: @dog.weight }
    end
  ...
  test "should update dog" do
    patch :update, id: @dog, dog: { breed: @dog.breed, concerns: @dog.concerns, image: @dog.image, name: @dog.name, suburb: @dog.suburb, weight: @dog.weight }
    assert_redirected_to dog_path(assigns(:dog))
  end
